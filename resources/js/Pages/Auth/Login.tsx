    ...
    return (
        <GuestLayout>
            ...
            <form onSubmit={submit} className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                    <label className="flex items-center gap-3 cursor-pointer group">
                        <Checkbox
                            ...
                            className="rounded border-slate-600 text-indigo-600 focus:ring-indigo-500/20 bg-slate-900/50"
                        />
                ...
                {/* Submit Button */}
                <PrimaryButton 
                    className="w-full justify-center py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-semibold rounded-xl shadow-lg shadow-indigo-500/25 transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed group"
                    disabled={processing}
                >
                    {processing ? (
